...
module.exports = {
    name: 'warn',
    aliases: ['alert'],
    description: "warns a member when mentioned!",
    async execute(client, message, cmd, args, Discord) {
        ...
        if (!message.guild.me.hasPermission("MANAGE_ROLES")) return message.channel.send('I require \`MANAGE ROLE\` permission to manage a users warnings.');
